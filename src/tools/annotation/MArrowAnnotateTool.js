...
/**
 * @public
 * @class MArrowAnnotateTool
 * @memberof Tools.Annotation
 * @classdesc Create and position an arrow and label
 * @extends Tools.Base.BaseAnnotationTool
 */
export default class MArrowAnnotateTool extends BaseAnnotationTool {
  constructor(props = {}) {
    const defaultProps = {
      name: 'MArrowAnnotate',
...
function getTextCallback(doneChangingTextCallback) {
  doneChangingTextCallback(
    getModule('globalConfiguration').configuration.mdntAnnotToolIndex
  );
}

function changeTextCallback(data, eventData, doneChangingTextCallback) {
  // doneChangingTextCallback('Change your annotation:');
}
