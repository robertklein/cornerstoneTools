 ...
 */
export default class SAPointTool extends BaseAnnotationTool {
  constructor(props = {}) {
    const defaultProps = {
      name: 'SAPoint',
  ...
  createNewMeasurement(eventData) {
    ...
    let type = 'add';
    const cType = getModule('globalConfiguration').configuration.SAPointType;
    if (typeof cType !== 'undefined') {
      type = cType;
    } else if (eventData.event.ctrlKey) {
      type = 'remove';
    }
